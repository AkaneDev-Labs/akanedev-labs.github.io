...
```
The `protocol` field MUST contain:
...
A complete v1 response could therefore look like:
```json
    {
      "protocol": "openmotd",
      "version": 1,
...
This ensures that OpenMOTD remains backwards-compatible as the protocol develops.